...
printf("Nummerical result=%lf \n Analytical result 3.14159265358979324 \nFunction called %i times\n",I,calls);
printf("Integration error %f\n",Err);
printf("No restrictions has been placed on the number of printed decimal places in the final result. This appears to be the number of decimals stored in the double...   \n");
